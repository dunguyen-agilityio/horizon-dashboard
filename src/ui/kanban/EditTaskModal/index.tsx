          ...
          <div className="flex flex-col justify-between lg:flex-row gap-4">
            <div className="flex flex-col gap-4">
              ...
              <Textarea
                ...
                disableAutosize
                classNames={{
                  inputWrapper: 'w-full lg:w-[500px]',
                  input:
                    'group-data-[has-value=true]:text-primary group-data-[has-value=true]:dark:text-white',
                }}
              />
            </div>
            <div className="flex flex-row flex-wrap md:flex-nowrap lg:flex-col gap-2 items-center justify-center">
              <Select
