...
const TaskForm = ({ onClose, onSubmit, status }: TaskFormProps) => {
  ...
  return (
    <div className="sticky top-0 z-10 pt-[18px] pl-[23px] pb-[23px] pr-[21px] rounded-[15px] bg-white shadow-light-card dark:shadow-none border-1 dark:bg-indigo-light max-w-[466px]">
      <form
