...
const Footer = () => (
  <footer className="sticky bottom-0 z-50 w-full bg-gray dark:bg-indigo-dark flex flex-col justify-between items-center px-1 gap-2 lg:gap-0 lg:flex-row xl:px-7 mb-6">
